...
\todo{Provide an overview of our contributions, what we did, state it in the least
controversial way possible. Think of these as bringing together chapter 6 and 7, couple of
sentences per section. Tie chapters together, say the uncontroversial part here.}

\todo{So like, in chapter X, we did this. Then use a couple sections per section.
Non-controversial, very matter-of-fact}

\section{Improving the Status Quo}%
\label{s:disc-improving}

\todo{Move this section to after the limitations}
...
\todo{Rename this to policy semantic issues in the policy language?}
...
\todo{Move this down to fine-grained network policy}
...
\Cref{ss:disc-fine-grained-network}.
...
\todo{Make it more clear that most of the limitations come from \gls{ebpf}}
