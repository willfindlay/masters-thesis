...
This thesis argues that the key to implementing light-weight confinement policies that
...
\begin{enumerate}[label=\textbf{RQ\arabic*.}]
  ...
  \item Can \gls{ebpf} be used to implement a full-featured confinement framework?
        What would such a framework look like and how would it compare with existing confinement frameworks?

  \item What levels of security and performance can we expect from a confinement mechanism
