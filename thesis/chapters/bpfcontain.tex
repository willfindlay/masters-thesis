...
specified with the \lstinline[language=yaml]|dev| keyword, rather than
\lstinline[language=yaml]|file|.
...
high-level use cases, rather than the underlying socket operations.
