...
\begin{inprogress}
  \begin{itemize}
    \item We review these foundational concepts in OS (particularly Unix) security
    \item This is pretty mainstream, you can find it anywhere you look
    \item Readers with an intermediate to advanced knowledge of operating systems can skip this section
  \end{itemize}
\end{inprogress}
