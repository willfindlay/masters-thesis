...
\begin{enumerate}
  ...
  \item \textbf{Virtualization.}
    ...
    filesystems~\todo{CITE} combined with the mount namespace aid containers in sharing
...
\begin{inprogress}
  \todo{Refactor and move this into The Confinement Problem?}
  ...
  While hypervisor escapes are not unheard of~\todo{CITE}, they are far less common than
