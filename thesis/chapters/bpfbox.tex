...
\section{Discrepancies in the \bpfbox{} Implementation}
\label{s:bpfbox-discrepancies}

\todo{List aspects of the \bpfbox{} design that have not been fully implemented}

\todo{Discuss how many aspects of the \bpfbox{} design made it into \bpfcontain{} (\Cref{c:bpfcontain})}
