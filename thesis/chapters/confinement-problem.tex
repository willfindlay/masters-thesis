...
\begin{comment}
  Have a diagram that positions virtual machines, containers, and standalone in terms
...
\begin{enumerate}[font=\bfseries]
  ...
  \item \textbf{Virtualization.}
    ...
    container to virtualize its network devices while the \glsentryfull{uts} namespace virtualizes host
...
\begin{enumerate}[font=\bfseries]
  ...
  \item \textbf{Process-Level and Container-Level Enforcement.}
    ...
    %Whereas existing \gls{lsm}-based security mechanisms are
    % focused on system-level confinement, \bpfbox{} and \bpfcontain{} should instead focus
    % on
...
The key insight behind this work is that novel kernel mechanisms are required to realize
